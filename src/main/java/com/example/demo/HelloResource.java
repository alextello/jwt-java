...
public class HelloResource {
    @GET
    @Produces("text/plain")
    public String hello() throws JoseException, MalformedClaimException, UnsupportedEncodingException {
...
//        System.out.println("privateKeyText====="+privateKeyText);
        ...
        String idToken = rsaKeyProducer.generateToken();
